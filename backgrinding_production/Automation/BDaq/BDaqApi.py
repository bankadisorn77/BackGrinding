...
class TDaqCtrlBase(object):
    ...
    def addEventHandler(obj, eventId, eventProc, userParam):
        dll.TDaqCtrlBase_addEventHandler.argtypes = [c_uint64, c_int32, c_void_p, c_void_p]
        dll.TDaqCtrlBase_addEventHandler(obj, eventId, eventProc, userParam)

    @staticmethod
    def removeEventHandler(obj, eventId, eventProc, userParam):
        dll.TDaqCtrlBase_removeEventHandler.argtypes = [c_uint64, c_int32, c_void_p, c_void_p]
        dll.TDaqCtrlBase_removeEventHandler(obj, eventId, eventProc, userParam)
    ...
    @staticmethod
    def getEthdaqEdge(obj, size, name):
        dll.TDaqCtrlBase_getEthdaqEdge.argtypes = [c_uint64, c_int32, c_wchar_p]
        return dll.TDaqCtrlBase_getEthdaqEdge(obj, size, name)
    ...
    @staticmethod
    def Login(obj, hostName, account, pwd, timeout):
        dll.TDaqCtrlBase_Login.argtypes = [c_uint64, c_wchar_p, c_wchar_p, c_wchar_p, c_int32]
        return dll.TDaqCtrlBase_Login(obj, hostName, account, pwd, timeout)
    
    @staticmethod
    def Logout(obj):
        dll.TDaqCtrlBase_Logout.argtypes = [c_uint64]
        return dll.TDaqCtrlBase_Logout(obj)
...
class TAiCtrlBase(object):
    ...
    @staticmethod
    def getChannelState(obj, count, state):
        dll.TAiCtrlBase_getChannelState.argtypes = [c_uint64, c_int32, POINTER(c_int32)]
        return dll.TAiCtrlBase_getChannelState(obj, count, state)
...
class TWaveformAiCtrl(object):
    ...
    @staticmethod
    def Release(obj):
        dll.TWaveformAiCtrl_Release.argtypes = [c_uint64]
        dll.TWaveformAiCtrl_Release(obj)
...
class TBufferedAoCtrl(object):
    ...
    @staticmethod
    def Release(obj):
        dll.TBufferedAoCtrl_Release.argtypes = [c_uint64]
        dll.TBufferedAoCtrl_Release(obj)
